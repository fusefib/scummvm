...
static const HopkinsGameDescription gameDescriptions[] = {
	...
	},
	{
		// Hopkins FBI Win95 Spanish
		{
			...
			ADGF_NO_FLAGS,
			GUIO4(GAMEOPTION_GORE_DEFAULT_ON, GAMEOPTION_WBASE_ENHANCEMENTS, GAMEOPTION_WBASE_FORCED_AUTOPLAY, GUIO_NOMIDI)
		},
	},
	{
		// Hopkins FBI Win95 UK, provided by Strangerke, alexbevi, greencis
		{
			...
			Common::kPlatformWindows,
			ADGF_NO_FLAGS,
			GUIO4(GAMEOPTION_GORE_DEFAULT_OFF, GAMEOPTION_WBASE_ENHANCEMENTS, GAMEOPTION_WBASE_FORCED_AUTOPLAY, GUIO_NOMIDI)
		},
	},
	{
