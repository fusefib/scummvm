...
static const MADSGameDescription gameDescriptions[] = {
...
#ifdef USE_TTS
			GUIO10(GUIO_NOSPEECH, GAMEOPTION_EASY_MOUSE, GAMEOPTION_ANIMATED_INVENTORY, GAMEOPTION_ANIMATED_INTERFACE, GAMEOPTION_NAUGHTY_MODE, GAMEOPTION_TTS_NARRATOR, GAMEOPTION_COPY_PROTECTION, GUIO_MIDIADLIB, GUIO_MIDIMT32, GUIO_MIDIPCSPK)
#else
			GUIO9(GUIO_NOSPEECH, GAMEOPTION_EASY_MOUSE, GAMEOPTION_ANIMATED_INVENTORY, GAMEOPTION_ANIMATED_INTERFACE, GAMEOPTION_NAUGHTY_MODE, GAMEOPTION_COPY_PROTECTION, GUIO_MIDIADLIB, GUIO_MIDIMT32, GUIO_MIDIPCSPK)
#endif
		},
		GType_RexNebular,
		0
...

	{
		// Rex Nebular and the Cosmic Gender Bender DOS English Demo
		{
			...
			GUIO6(GUIO_NOSPEECH, GAMEOPTION_EASY_MOUSE, GAMEOPTION_ANIMATED_INVENTORY, GAMEOPTION_ANIMATED_INTERFACE, GAMEOPTION_NAUGHTY_MODE, GUIO_MIDIMT32)
		},
		GType_RexNebular,
		0
	},
