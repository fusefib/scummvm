...
static const MADSGameDescription gameDescriptions[] = {
...

	{
		// Rex Nebular and the Cosmic Gender Bender DOS English Demo
		{
			...
			GUIO7(GUIO_NOSPEECH, GAMEOPTION_EASY_MOUSE, GAMEOPTION_ANIMATED_INVENTORY, GAMEOPTION_ANIMATED_INTERFACE, GAMEOPTION_NAUGHTY_MODE, GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_PAS)
		},
		GType_RexNebular,
		0
	},
...

	{
		// Return of the Phantom DOS English Demo
		{
			...
			Common::kPlatformDOS,
			ADGF_UNSTABLE | ADGF_DEMO,
			GUIO4(GUIO_NOMIDI, GAMEOPTION_EASY_MOUSE, GAMEOPTION_ORIGINAL_SAVELOAD, GAMEOPTION_PAS)
		},
		GType_Phantom,
		0
	},
