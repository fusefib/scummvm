...
#ifndef MADS_NEBULAR_ISOUND_SECTIONS_H
#define MADS_NEBULAR_ISOUND_SECTIONS_H
...
protected:
	ISoundSection(Audio::Mixer *mixer, OPL::OPL *opl, const char *filename,
