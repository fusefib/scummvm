...
ISoundSection::ISoundSection(Audio::Mixer *mixer, OPL::OPL *opl,
		const char *filename, const ISoundCommandSequence *commands,
		uint commandCount) :
		ISound(mixer, opl, filename),
		_commands(commands),
...
ISound1::ISound1(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.001", kSection1Commands,
				ARRAYSIZE(kSection1Commands)) {
}

ISound2::ISound2(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.002", kSection2Commands,
				ARRAYSIZE(kSection2Commands)) {
}

ISound3::ISound3(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISound3(mixer, opl, "ISOUND.003") {
}

ISound3::ISound3(Audio::Mixer *mixer, OPL::OPL *opl, const char *filename) :
		ISoundSection(mixer, opl, filename, kSection3Commands,
				ARRAYSIZE(kSection3Commands)) {
}

ISound4::ISound4(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISound3(mixer, opl, "ISOUND.004") {
}

ISound5::ISound5(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.005", kSection5Commands,
				ARRAYSIZE(kSection5Commands)) {
}

ISound6::ISound6(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.006", kSection6Commands,
				ARRAYSIZE(kSection6Commands)) {
}

ISound7::ISound7(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.007", kSection7Commands,
				ARRAYSIZE(kSection7Commands)) {
}

ISound8::ISound8(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.008", kSection8Commands,
				ARRAYSIZE(kSection8Commands)) {
}

ISound9::ISound9(Audio::Mixer *mixer, OPL::OPL *opl) :
		ISoundSection(mixer, opl, "ISOUND.009", kSection9Commands,
